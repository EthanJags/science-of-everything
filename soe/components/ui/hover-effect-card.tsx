...
export const CardTitle = ({
  ...
  return (
    <h4
      className={cn(
        "text-zinc-100 font-bold tracking-wide px-4 mt-4",
        className
      )}
    >
      {children}
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "mt-2 text-zinc-400 tracking-wide leading-relaxed text-sm px-4 flex-grow",
        className
      )}
    >
      {children}
  ...
  return (
    <div className="px-4 pb-4 mt-4">
      <Link
        href={link}
        className={cn(
          "inline-flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-black bg-white rounded-lg hover:bg-zinc-200 transition-colors duration-200",
          className
        )}
      >
        Listen Now
